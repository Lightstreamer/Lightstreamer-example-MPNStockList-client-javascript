    ...
    return new Promise((resolve, reject) => {
        ...
        var mpnDeviceListener= {
                ...
                onSubscriptionsUpdated: function() {
                    console.log("MPN subscriptions updated: " + lsClient.getMpnSubscriptions().length + " active MPN subscriptions");

                    // Enumerate the suscriptions
                    enumerateMpnSubscriptions(subscriptionEnumerator);
                }
        };
        ...
        if (window.safari != undefined) {
            ...
            var checkRemotePermission= function(permissionData) {
                if (permissionData.permission === 'default') {
                    ...
                    mpnDevice= new Ls.MpnDevice(permissionData.deviceToken, APPLE_APP_ID, 'Apple');
